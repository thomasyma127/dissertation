Run this code in Jupyter Notebook. Please ensure that the file path contains the folders 'oleshape', 'railshape', and 'climate', and that the corresponding files are placed inside these folders.
